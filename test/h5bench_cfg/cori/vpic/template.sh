...
#SBATCH -L SCRATCH
#SBATCH -C haswell
#SBATCH -J FSTYPE_vpic
#SBATCH -A m2621
#SBATCH -o o%j.vpic_FSTYPE
#SBATCH -e o%j.vpic_FSTYPE
...
EXEC=/global/u1/h/houhun/h5bench/build/h5bench_vpicio
SYNC_INPUT=/global/u1/h/houhun/h5bench/scripts/vpic_cc1d_sync.cfg
ASYNC_INPUT=/global/u1/h/houhun/h5bench/scripts/vpic_cc1d_async.cfg
