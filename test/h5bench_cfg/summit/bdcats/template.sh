...
#BSUB -J bdcats_NNODEnode
#BSUB -o o%J.bdcats_NNODEnode
#BSUB -e o%J.bdcats_NNODEnode
...
EXEC=${H5BENCH_HOME}/h5bench_bdcatsio
SYNC_INPUT=${ASYNC_HOME}/h5bench_cfg/bdcats_cc1d_sync.cfg
ASYNC_INPUT=${ASYNC_HOME}/h5bench_cfg/bdcats_cc1d_async.cfg
