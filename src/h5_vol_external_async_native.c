...
typedef struct H5VL_async_t {
	...
	// To make dset write not requiring dset create to complete (still requries dset open to
	// complete)
...
/* Helper routines */
static herr_t H5VL_async_file_specific_reissue (void *obj,
												hid_t connector_id,
												H5VL_file_specific_t specific_type,
												hid_t dxpl_id,
												void **req,
												...);
static herr_t H5VL_async_request_specific_reissue (void *obj,
												   hid_t connector_id,
...
/* Attribute callbacks */
static void *H5VL_async_attr_create (void *obj,
									 const H5VL_loc_params_t *loc_params,
									 const char *name,
									 hid_t type_id,
									 hid_t space_id,
									 ...
									 hid_t dxpl_id,
									 void **req);
static void *H5VL_async_attr_open (void *obj,
								   const H5VL_loc_params_t *loc_params,
								   const char *name,
								   hid_t aapl_id,
								   hid_t dxpl_id,
								   void **req);
static herr_t H5VL_async_attr_read (
	void *attr, hid_t mem_type_id, void *buf, hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_write (
	void *attr, hid_t mem_type_id, const void *buf, hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_get (
	void *obj, H5VL_attr_get_t get_type, hid_t dxpl_id, void **req, va_list arguments);
static herr_t H5VL_async_attr_specific (void *obj,
										const H5VL_loc_params_t *loc_params,
										H5VL_attr_specific_t specific_type,
										hid_t dxpl_id,
										void **req,
										va_list arguments);
static herr_t H5VL_async_attr_optional (
...
/* Dataset callbacks */
static void *H5VL_async_dataset_create (void *obj,
										const H5VL_loc_params_t *loc_params,
										const char *name,
										hid_t lcpl_id,
										hid_t type_id,
										...
										hid_t dxpl_id,
										void **req);
static void *H5VL_async_dataset_open (void *obj,
									  const H5VL_loc_params_t *loc_params,
									  const char *name,
									  hid_t dapl_id,
									  hid_t dxpl_id,
									  void **req);
static herr_t H5VL_async_dataset_read (void *dset,
									   hid_t mem_type_id,
									   hid_t mem_space_id,
									   hid_t file_space_id,
									   hid_t plist_id,
									   void *buf,
									   void **req);
static herr_t H5VL_async_dataset_write (void *dset,
										hid_t mem_type_id,
										hid_t mem_space_id,
										hid_t file_space_id,
										hid_t plist_id,
...
/* Datatype callbacks */
static void *H5VL_async_datatype_commit (void *obj,
										 const H5VL_loc_params_t *loc_params,
										 const char *name,
										 hid_t type_id,
										 hid_t lcpl_id,
										 ...
										 hid_t dxpl_id,
										 void **req);
static void *H5VL_async_datatype_open (void *obj,
									   const H5VL_loc_params_t *loc_params,
									   const char *name,
									   hid_t tapl_id,
									   hid_t dxpl_id,
									   void **req);
static herr_t H5VL_async_datatype_get (
	void *dt, H5VL_datatype_get_t get_type, hid_t dxpl_id, void **req, va_list arguments);
static herr_t H5VL_async_datatype_specific (void *obj,
											H5VL_datatype_specific_t specific_type,
											hid_t dxpl_id,
											void **req,
											va_list arguments);
static herr_t H5VL_async_datatype_optional (
...
/* Group callbacks */
static void *H5VL_async_group_create (void *obj,
									  const H5VL_loc_params_t *loc_params,
									  const char *name,
									  hid_t lcpl_id,
									  hid_t gcpl_id,
...
/* Link callbacks */
static herr_t H5VL_async_link_create (H5VL_link_create_type_t create_type,
									  void *obj,
									  const H5VL_loc_params_t *loc_params,
									  hid_t lcpl_id,
									  hid_t lapl_id,
									  ...
									  void **req,
									  va_list arguments);
static herr_t H5VL_async_link_copy (void *src_obj,
									...
									hid_t dxpl_id,
									void **req);
static herr_t H5VL_async_link_move (void *src_obj,
									const H5VL_loc_params_t *loc_params1,
									void *dst_obj,
									const H5VL_loc_params_t *loc_params2,
									hid_t lcpl_id,
									...
									hid_t dxpl_id,
									void **req);
static herr_t H5VL_async_link_get (void *obj,
								   const H5VL_loc_params_t *loc_params,
								   H5VL_link_get_t get_type,
								   hid_t dxpl_id,
								   void **req,
								   va_list arguments);
static herr_t H5VL_async_link_specific (void *obj,
										const H5VL_loc_params_t *loc_params,
										H5VL_link_specific_t specific_type,
										hid_t dxpl_id,
										void **req,
										va_list arguments);
static herr_t H5VL_async_link_optional (
	void *obj, H5VL_link_optional_t opt_type, hid_t dxpl_id, void **req, va_list arguments);

/* Object callbacks */
static void *H5VL_async_object_open (void *obj,
									 const H5VL_loc_params_t *loc_params,
									 H5I_type_t *opened_type,
									 hid_t dxpl_id,
									 void **req);
static herr_t H5VL_async_object_copy (void *src_obj,
									  ...
									  hid_t dxpl_id,
									  void **req);
static herr_t H5VL_async_object_get (void *obj,
									 const H5VL_loc_params_t *loc_params,
									 H5VL_object_get_t get_type,
									 hid_t dxpl_id,
									 void **req,
									 va_list arguments);
static herr_t H5VL_async_object_specific (void *obj,
										  const H5VL_loc_params_t *loc_params,
										  H5VL_object_specific_t specific_type,
										  hid_t dxpl_id,
										  void **req,
										  va_list arguments);
static herr_t H5VL_async_object_optional (
	void *obj, H5VL_object_optional_t opt_type, hid_t dxpl_id, void **req, va_list arguments);

/* Container/connector introspection callbacks */
static herr_t H5VL_async_introspect_get_conn_cls (void *obj,
												  H5VL_get_conn_lvl_t lvl,
												  const H5VL_class_t **conn_cls);
static herr_t H5VL_async_introspect_opt_query (void *obj,
											   H5VL_subclass_t cls,
											   int opt_type,
											   hbool_t *supported);
...
static herr_t H5VL_async_request_specific (void *req,
										   H5VL_request_specific_t specific_type,
										   va_list arguments);
static herr_t H5VL_async_request_optional (void *req,
										   H5VL_request_optional_t opt_type,
										   va_list arguments);
static herr_t H5VL_async_request_free (void *req);

/* Blob callbacks */
static herr_t H5VL_async_blob_put (
	void *obj, const void *buf, size_t size, void *blob_id, void *ctx);
static herr_t H5VL_async_blob_get (
	void *obj, const void *blob_id, void *buf, size_t size, void *ctx);
static herr_t H5VL_async_blob_specific (void *obj,
										void *blob_id,
										H5VL_blob_specific_t specific_type,
										va_list arguments);
static herr_t H5VL_async_blob_optional (void *obj,
										void *blob_id,
										H5VL_blob_optional_t opt_type,
										va_list arguments);

/* Token callbacks */
static herr_t H5VL_async_token_cmp (void *obj,
									const H5O_token_t *token1,
									const H5O_token_t *token2,
									int *cmp_value);
static herr_t H5VL_async_token_to_str (void *obj,
									   H5I_type_t obj_type,
									   const H5O_token_t *token,
									   char **token_str);
static herr_t H5VL_async_token_from_str (void *obj,
										 H5I_type_t obj_type,
										 const char *token_str,
										 H5O_token_t *token);

/* Generic optional callback */
static herr_t H5VL_async_optional (
	void *obj, int op_type, hid_t dxpl_id, void **req, va_list arguments);
...
static herr_t async_init (hid_t vipl_id) {
	herr_t ret_val = 1;
	int abt_ret;
...
herr_t async_instance_finalize (void) {
	int abt_ret, ret_val = 1;
	int i;

	if (NULL == async_instance_g) return 0;
...
herr_t async_instance_init (int backing_thread_count) {
	herr_t hg_ret = 0;
	...
	if (NULL != async_instance_g) return 1;
...
async_task_t *create_async_task (void) {
...
static void free_async_task (async_task_t *task) {
...
static void free_file_async_resources (H5VL_async_t *file) {
	async_task_t *task_iter, *tmp;
	...
	DL_FOREACH_SAFE2 (file->file_async_obj->file_task_list_head, task_iter, tmp, file_list_next) {
		DL_DELETE2 (file->file_async_obj->file_task_list_head, task_iter, file_list_prev,
					file_list_next);
...
static herr_t add_to_dep_task (async_task_t *task, async_task_t *dep_task) {
	assert (task);
	assert (dep_task);
	...
	if (task->n_dep_alloc == 0 || task->dep_tasks == NULL) {
		...
		task->dep_tasks = (async_task_t **)realloc (
			task->dep_tasks, task->n_dep_alloc * 2 * sizeof (async_task_t *));
...
static herr_t push_task_to_abt_pool (async_qhead_t *qhead, ABT_pool pool) {
	int i, is_dep_done;
		...
		if (qhead->queue->type == DEPENDENT) {
			...
			for (i = 0; i < task_elt->n_dep; i++) {
				if (NULL != task_elt->dep_tasks[i]->abt_thread) {
					...
					/* if (ABT_task_get_state(task_elt->dep_tasks[i]->abt_task, &task_state) !=
					 * ABT_SUCCESS) { */
					...
					if (thread_state != ABT_THREAD_STATE_TERMINATED &&
						thread_state != ABT_THREAD_STATE_RUNNING) {
						is_dep_done = 0;
						break;
					}
				}
...
int get_n_running_task_in_queue (async_task_t *task) {
	...
	DL_FOREACH2 (task->async_obj->file_task_list_head, task_elt, file_list_next) {
		if (task_elt->abt_thread != NULL) {
			...
			if (thread_state == ABT_THREAD_STATE_RUNNING) { remaining_task++; }
		}
	}
 ...
 * operations. There can only be 1 collective operation in execution at any time (amongst all the
 * threads on a process).
 */
static herr_t add_task_to_queue (async_qhead_t *qhead,
								 async_task_t *task,
								 task_list_qtype task_type) {
	int is_end, is_end2;
	/* int is_dep = 0; */
	...
	if (task_type != COLLECTIVE) {
		...
		DL_FOREACH2 (tail_list, task_list_elt, prev) {
			...
			DL_FOREACH2 (tail_task, task_elt, prev) {
				...
				if (is_end2 == 1 && tail_task == task_elt) break;
				is_end2 = 1;
			}
			if (is_end == 1 && tail_list == task_list_elt) break;
			is_end = 1;
			/* if (is_dep == 1) { break; } */
		}
		...
		DL_FOREACH2 (task->async_obj->file_task_list_head, task_elt, file_list_next) {
			if (task_elt->in_abt_pool == 1 && task_elt->async_obj &&
				task_elt->async_obj == task->async_obj &&
				!(task->op == READ && task_elt->op == READ)) {
				task_type = DEPENDENT;
				if (add_to_dep_task (task, task_elt) < 0) {
					fprintf (stderr, "  [ASYNC VOL ERROR] %s add_to_dep_task failed\n", __func__);
		...
		if (ABT_mutex_unlock (task->async_obj->file_async_obj->file_task_list_mutex) !=
			ABT_SUCCESS) {
			fprintf (stderr, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
			return -1;
		}
	...
	/*     if (ABT_thread_create(*(task->async_obj->pool_ptr), task->func, task,
	 * ABT_THREAD_ATTR_NULL, &task->abt_thread) != ABT_SUCCESS) { */
	/*         fprintf(stderr,"  [ASYNC VOL ERROR] %s ABT_thread_create failed for %p\n", __func__,
	 * task->func); */
	/*         return -1; */
	/*     } */
...
void dup_loc_param (H5VL_loc_params_t *dest, H5VL_loc_params_t const *loc_params) {
	...
	if (loc_params->type == H5VL_OBJECT_BY_NAME) {
		...
		memcpy ((void *)(dest->loc_data.loc_by_token.token),
				loc_params->loc_data.loc_by_token.token, ref_size);
	}
}
...
herr_t H5VL_async_dataset_wait (H5VL_async_t *async_obj) {
	...
	DL_FOREACH2 (async_obj->file_task_list_head, task_iter, file_list_next) {
		...
		if (task_iter->async_obj == async_obj) {
			if (task_iter->is_done != 1) { ABT_eventual_wait (task_iter->eventual, NULL); }
		}
		/* if (ABT_mutex_unlock(async_obj->obj_mutex) != ABT_SUCCESS) */
		/*     fprintf(stderr,"  [ASYNC VOL ERROR] %s ABT_mutex_lock failed\n", __func__); */
	}
...
herr_t H5Pset_dxpl_async (hid_t dxpl, void **req) {
	herr_t ret;
	size_t len = sizeof (hbool_t);

	if ((ret = H5Pinsert (dxpl, ASYNC_VOL_PROP_NAME, len, (void *)&is_async, NULL, NULL, NULL, NULL,
						  NULL, NULL)) < 0)
...
herr_t H5Pset_dxpl_async_cp_limit (hid_t dxpl, hsize_t size) {
	...
	if ((ret = H5Pinsert (dxpl, ASYNC_VOL_CP_SIZE_LIMIT_NAME, len, (void *)&size, NULL, NULL, NULL,
						  NULL, NULL, NULL)) < 0)
		fprintf (stderr, "  [ASYNC VOL ERROR] %s H5Pinsert failed\n", __func__);
...
static herr_t dataset_get_wrapper (
	void *dset, hid_t driver_id, H5VL_dataset_get_t get_type, hid_t dxpl_id, void **req, ...) {
	herr_t ret;
	va_list args;
	va_start (args, req);
...
herr_t H5VLasync_get_data_size (void *dset, hid_t space, hid_t connector_id, hsize_t *size) {
	herr_t ret;
	hid_t dset_type, dset_space;

	if ((ret = dataset_get_wrapper (dset, connector_id, H5VL_DATASET_GET_TYPE,
									H5P_DATASET_XFER_DEFAULT, NULL, (void *)&dset_type)) < 0) {
...
herr_t H5VLasync_get_data_nelem (void *dset, hid_t space, hid_t connector_id, hsize_t *size) {
	herr_t ret = 0;
	hid_t dset_space;
...
double get_elapsed_time (struct timeval *tstart, struct timeval *tend) {
	return (
		double)(((tend->tv_sec - tstart->tv_sec) * 1000000LL + tend->tv_usec - tstart->tv_usec) /
				1000000.0);
}
...
void H5VLasync_waitall () {
	...
	while (async_instance_g && (async_instance_g->nfopen > 0 || size > 0)) {
		...
		if (size == 0) {
			if (async_instance_g->nfopen == 0) break;
		}
	}
...
void H5VLasync_finalize () { H5VLasync_waitall (); }
...
static void async_attr_create_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	...
	fprintf (stderr, "  [ASYNC ABT LOG] Argobots execute %s start, time=%ld.%06ld\n", __func__,
			 args->start_time.tv_sec, args->start_time.tv_usec);
#endif
#ifdef ENABLE_LOG
	...
	while (acquired == false) {
		...
		if (async_instance_g->ex_delay == false &&
			H5TSmutex_get_attempt_count (&attempt_count) < 0) {
		...
		fprintf (stderr, "  [ASYNC ABT DBG] %s lock count = %d, time=%ld.%06ld\n", __func__,
				 attempt_count, now_time.tv_sec, now_time.tv_usec);
#endif
		if (H5TSmutex_acquire (&acquired) < 0) {
	...
	if ((obj = H5VLattr_create (args->obj, args->loc_params, task->under_vol_id, args->name,
								args->type_id, args->space_id, args->acpl_id, args->aapl_id,
								args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_attr_create (int is_blocking,
										async_instance_t *aid,
										H5VL_async_t *parent_obj,
										const H5VL_loc_params_t *loc_params,
										const char *name,
										hid_t type_id,
										hid_t space_id,
	...
	if ((args = (async_attr_create_args_t *)calloc (1, sizeof (async_attr_create_args_t))) ==
		NULL) {
	...
	fprintf (stderr, "  [ASYNC VOL TIMING] entering %s, time=%ld.%06ld\n", __func__,
			 args->create_time.tv_sec, args->create_time.tv_usec);
	fflush (stderr);
#endif
	...
	if (type_id > 0) args->type_id = H5Tcopy (type_id);
	if (space_id > 0) args->space_id = H5Scopy (space_id);
	if (acpl_id > 0) args->acpl_id = H5Pcopy (acpl_id);
	if (aapl_id > 0) args->aapl_id = H5Pcopy (aapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
	...
	printf ("  [ASYNC VOL TIMING] %-24s \t  create time   : %f\n", __func__,
			get_elapsed_time (&args->create_time, &now_time));
#endif
...
static void async_attr_open_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	...
	if ((obj = H5VLattr_open (args->obj, args->loc_params, task->under_vol_id, args->name,
							  args->aapl_id, args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_attr_open (int is_blocking,
									  async_instance_t *aid,
									  H5VL_async_t *parent_obj,
									  const H5VL_loc_params_t *loc_params,
									  const char *name,
...
static void async_attr_read_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
	...
	if (H5VLattr_read (args->attr, task->under_vol_id, args->mem_type_id, args->buf, args->dxpl_id,
					   args->req) < 0) {
...
static herr_t async_attr_read (int is_blocking,
							   async_instance_t *aid,
							   H5VL_async_t *parent_obj,
							   hid_t mem_type_id,
							   void *buf,
	...
	if (mem_type_id > 0) args->mem_type_id = H5Tcopy (mem_type_id);
	args->buf = buf;
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
...
static void async_attr_write_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLattr_write (args->attr, task->under_vol_id, args->mem_type_id, args->buf, args->dxpl_id,
						args->req) < 0) {
...
static herr_t async_attr_write (int is_blocking,
								async_instance_t *aid,
								H5VL_async_t *parent_obj,
								hid_t mem_type_id,
								const void *buf,
...
static void async_attr_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLattr_get (args->obj, task->under_vol_id, args->get_type, args->dxpl_id, args->req,
					  args->arguments) < 0) {
...
static herr_t async_attr_get (int is_blocking,
							  async_instance_t *aid,
							  H5VL_async_t *parent_obj,
							  H5VL_attr_get_t get_type,
							  hid_t dxpl_id,
...
static void async_attr_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLattr_specific (args->obj, args->loc_params, task->under_vol_id, args->specific_type,
						   args->dxpl_id, args->req, args->arguments) < 0) {
...
static herr_t async_attr_specific (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   const H5VL_loc_params_t *loc_params,
								   H5VL_attr_specific_t specific_type,
	...
	if ((args = (async_attr_specific_args_t *)calloc (1, sizeof (async_attr_specific_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_attr_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLattr_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id, args->req,
						   args->arguments) < 0) {
...
static herr_t async_attr_optional (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   H5VL_attr_optional_t opt_type,
								   hid_t dxpl_id,
	...
	if ((args = (async_attr_optional_args_t *)calloc (1, sizeof (async_attr_optional_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((ret_value = H5VLattr_close (args->attr, task->under_vol_id, args->dxpl_id, args->req)) <
		0) {
...
static herr_t async_attr_close (
	int is_blocking, async_instance_t *aid, H5VL_async_t *parent_obj, hid_t dxpl_id, void **req) {
	async_task_t *async_task = NULL;
	/* H5O_token_t *token = NULL; */
...
static void async_dataset_create_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLdataset_create (args->obj, args->loc_params, task->under_vol_id, args->name,
								   args->lcpl_id, args->type_id, args->space_id, args->dcpl_id,
								   args->dapl_id, args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_dataset_create (int is_blocking,
										   async_instance_t *aid,
										   H5VL_async_t *parent_obj,
										   const H5VL_loc_params_t *loc_params,
										   const char *name,
	...
	if ((args = (async_dataset_create_args_t *)calloc (1, sizeof (async_dataset_create_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	dup_loc_param (args->loc_params, loc_params);
	args->name = strdup (name);
	if (lcpl_id > 0) args->lcpl_id = H5Pcopy (lcpl_id);
	if (type_id > 0) args->type_id = H5Tcopy (type_id);
	if (space_id > 0) args->space_id = H5Scopy (space_id);
	if (dcpl_id > 0) args->dcpl_id = H5Pcopy (dcpl_id);
	if (dapl_id > 0) args->dapl_id = H5Pcopy (dapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
	...
	if (async_obj->dset_size > 0) async_obj->has_dset_size = true;
...
static void async_dataset_open_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLdataset_open (args->obj, args->loc_params, task->under_vol_id, args->name,
								 args->dapl_id, args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_dataset_open (int is_blocking,
										 async_instance_t *aid,
										 H5VL_async_t *parent_obj,
										 const H5VL_loc_params_t *loc_params,
										 const char *name,
	...
	if ((args = (async_dataset_open_args_t *)calloc (1, sizeof (async_dataset_open_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_dataset_read_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdataset_read (args->dset, task->under_vol_id, args->mem_type_id, args->mem_space_id,
...
static herr_t async_dataset_read (int is_blocking,
								  async_instance_t *aid,
								  H5VL_async_t *parent_obj,
								  hid_t mem_type_id,
								  hid_t mem_space_id,
	...
	if ((args = (async_dataset_read_args_t *)calloc (1, sizeof (async_dataset_read_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	if (mem_type_id > 0) args->mem_type_id = H5Tcopy (mem_type_id);
	if (mem_space_id > 0) args->mem_space_id = H5Scopy (mem_space_id);
	if (file_space_id > 0) args->file_space_id = H5Scopy (file_space_id);
	if (plist_id > 0) args->plist_id = H5Pcopy (plist_id);
	args->buf = buf;
	args->req = req;
...
static void async_dataset_write_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (args->memcpy_mode == MEM_GATHER && args->gather_space_id != 0) {
		if (H5VLdataset_write (args->dset, task->under_vol_id, args->mem_type_id,
							   args->gather_space_id, args->file_space_id, args->plist_id,
							   args->buf, args->req) < 0) {
		...
		if (H5VLdataset_write (args->dset, task->under_vol_id, args->mem_type_id,
							   args->mem_space_id, args->file_space_id, args->plist_id, args->buf,
							   args->req) < 0) {
			fprintf (stderr, "  [ASYNC ABT ERROR] %s H5VLdataset_write failed\n", __func__);
			goto done;
		}
...
int is_contig_memspace (hid_t memspace) {
	...
	if (memspace == H5S_SEL_ALL || memspace == H5S_SEL_NONE) { return 1; }
...
static herr_t async_dataset_write (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   hid_t mem_type_id,
								   hid_t mem_space_id,
	...
	if ((args = (async_dataset_write_args_t *)calloc (1, sizeof (async_dataset_write_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	if (cp_size_limit > 0) {
		if (parent_obj->has_dset_size && args->file_space_id == H5S_ALL &&
			parent_obj->dset_size > 0) {
			// Check for cached dset size
			buf_size = parent_obj->dset_size;
		} else {
			// Get dset size
			if (parent_obj->dtype_size > 0) {
				if (H5VLasync_get_data_nelem (args->dset, args->file_space_id,
											  parent_obj->under_vol_id, &buf_size) < 0) {
					fprintf (stderr, "  [ASYNC VOL ERROR] %s H5VLasync_get_data_nelem failed\n",
							 __func__);
					goto done;
				}
				buf_size *= parent_obj->dtype_size;
			} else if (H5VLasync_get_data_size (args->dset, args->file_space_id,
												parent_obj->under_vol_id, &buf_size) < 0) {
		...
		if (buf_size <= cp_size_limit) {
			...
			if (1 == is_contig_memspace (mem_space_id)) args->memcpy_mode = MEM_DEFAULT;
		...
		// if buf_size is larger than copy size limit, do not memcpy and assume user buffer is not
		// modified until actual write happens
		/* else { */
		/*     enable_async = false; */
		/*     fprintf(stdout,"  [ASYNC VOL] %s buf size [%llu] is larger than cp_size_limit [%llu],
...
static void async_dataset_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdataset_get (args->dset, task->under_vol_id, args->get_type, args->dxpl_id, args->req,
						 args->arguments) < 0) {
...
static herr_t async_dataset_get (int is_blocking,
								 async_instance_t *aid,
								 H5VL_async_t *parent_obj,
								 H5VL_dataset_get_t get_type,
								 hid_t dxpl_id,
	...
	if ((args = (async_dataset_get_args_t *)calloc (1, sizeof (async_dataset_get_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_dataset_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdataset_specific (args->obj, task->under_vol_id, args->specific_type, args->dxpl_id,
							  args->req, args->arguments) < 0) {
...
static herr_t async_dataset_specific (int is_blocking,
									  async_instance_t *aid,
									  H5VL_async_t *parent_obj,
									  H5VL_dataset_specific_t specific_type,
									  hid_t dxpl_id,
	...
	if ((args = (async_dataset_specific_args_t *)calloc (
			 1, sizeof (async_dataset_specific_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
...
static void async_dataset_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdataset_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id,
							  args->req, args->arguments) < 0) {
...
static herr_t async_dataset_optional (int is_blocking,
									  async_instance_t *aid,
									  H5VL_async_t *parent_obj,
									  H5VL_dataset_optional_t opt_type,
									  hid_t dxpl_id,
	...
	if ((args = (async_dataset_optional_args_t *)calloc (
			 1, sizeof (async_dataset_optional_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
...
static void async_dataset_close_fn (void *foo) {
	herr_t ret_value;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((ret_value = H5VLdataset_close (args->dset, task->under_vol_id, args->dxpl_id, args->req)) <
		0) {
...
static herr_t async_dataset_close (
	int is_blocking, async_instance_t *aid, H5VL_async_t *parent_obj, hid_t dxpl_id, void **req) {
	async_task_t *async_task = NULL;
	/* H5O_token_t *token = NULL; */
	...
	if ((args = (async_dataset_close_args_t *)calloc (1, sizeof (async_dataset_close_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_datatype_commit_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdatatype_commit (args->obj, args->loc_params, task->under_vol_id, args->name,
							 args->type_id, args->lcpl_id, args->tcpl_id, args->tapl_id,
							 args->dxpl_id, args->req) < 0) {
...
static H5VL_async_t *async_datatype_commit (int is_blocking,
											async_instance_t *aid,
											H5VL_async_t *parent_obj,
											const H5VL_loc_params_t *loc_params,
											const char *name,
	...
	if ((args = (async_datatype_commit_args_t *)calloc (
			 1, sizeof (async_datatype_commit_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
	...
	if (type_id > 0) args->type_id = H5Tcopy (type_id);
	if (lcpl_id > 0) args->lcpl_id = H5Pcopy (lcpl_id);
	if (tcpl_id > 0) args->tcpl_id = H5Pcopy (tcpl_id);
	if (tapl_id > 0) args->tapl_id = H5Pcopy (tapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
...
static void async_datatype_open_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLdatatype_open (args->obj, args->loc_params, task->under_vol_id, args->name,
								  args->tapl_id, args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_datatype_open (int is_blocking,
										  async_instance_t *aid,
										  H5VL_async_t *parent_obj,
										  const H5VL_loc_params_t *loc_params,
										  const char *name,
	...
	if ((args = (async_datatype_open_args_t *)calloc (1, sizeof (async_datatype_open_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_datatype_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdatatype_get (args->dt, task->under_vol_id, args->get_type, args->dxpl_id, args->req,
						  args->arguments) < 0) {
...
static herr_t async_datatype_get (int is_blocking,
								  async_instance_t *aid,
								  H5VL_async_t *parent_obj,
								  H5VL_datatype_get_t get_type,
								  hid_t dxpl_id,
	...
	if ((args = (async_datatype_get_args_t *)calloc (1, sizeof (async_datatype_get_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_datatype_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdatatype_specific (args->obj, task->under_vol_id, args->specific_type, args->dxpl_id,
							   args->req, args->arguments) < 0) {
...
static herr_t async_datatype_specific (int is_blocking,
									   async_instance_t *aid,
									   H5VL_async_t *parent_obj,
									   H5VL_datatype_specific_t specific_type,
									   hid_t dxpl_id,
	...
	if ((args = (async_datatype_specific_args_t *)calloc (
			 1, sizeof (async_datatype_specific_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
...
static void async_datatype_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLdatatype_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id,
							   args->req, args->arguments) < 0) {
...
static herr_t async_datatype_optional (int is_blocking,
									   async_instance_t *aid,
									   H5VL_async_t *parent_obj,
									   H5VL_datatype_optional_t opt_type,
									   hid_t dxpl_id,
	...
	if ((args = (async_datatype_optional_args_t *)calloc (
			 1, sizeof (async_datatype_optional_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
...
static void async_datatype_close_fn (void *foo) {
	herr_t ret_value;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((ret_value = H5VLdatatype_close (args->dt, task->under_vol_id, args->dxpl_id, args->req)) <
		0) {
...
static herr_t async_datatype_close (
	int is_blocking, async_instance_t *aid, H5VL_async_t *parent_obj, hid_t dxpl_id, void **req) {
	async_task_t *async_task = NULL;
	/* H5O_token_t *token = NULL; */
	...
	if ((args = (async_datatype_close_args_t *)calloc (1, sizeof (async_datatype_close_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_file_create_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLfile_create (args->name, args->flags, args->fcpl_id, under_fapl_id,
								args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_file_create (int is_blocking,
										async_instance_t *aid,
										const char *name,
										unsigned flags,
										hid_t fcpl_id,
	...
	if ((args = (async_file_create_args_t *)calloc (1, sizeof (async_file_create_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	args->name	= strdup (name);
	args->flags = flags;
	if (fcpl_id > 0) args->fcpl_id = H5Pcopy (fcpl_id);
	if (fapl_id > 0) args->fapl_id = H5Pcopy (fapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
...
static void async_file_open_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	...
	if ((obj = H5VLfile_open (args->name, args->flags, under_fapl_id, args->dxpl_id, args->req)) ==
		NULL) {
...
static H5VL_async_t *async_file_open (int is_blocking,
									  async_instance_t *aid,
									  const char *name,
									  unsigned flags,
									  hid_t fapl_id,
...
static void async_file_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLfile_get (args->file, task->under_vol_id, args->get_type, args->dxpl_id, args->req,
					  args->arguments) < 0) {
...
static herr_t async_file_get (int is_blocking,
							  async_instance_t *aid,
							  H5VL_async_t *parent_obj,
							  H5VL_file_get_t get_type,
							  hid_t dxpl_id,
...
static void async_file_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLfile_specific (args->file, task->under_vol_id, args->specific_type, args->dxpl_id,
						   args->req, args->arguments) < 0) {
...
static herr_t async_file_specific (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   H5VL_file_specific_t specific_type,
								   hid_t dxpl_id,
	...
	if ((args = (async_file_specific_args_t *)calloc (1, sizeof (async_file_specific_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_file_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLfile_optional (args->file, task->under_vol_id, args->opt_type, args->dxpl_id, args->req,
						   args->arguments) < 0) {
...
static herr_t async_file_optional (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   H5VL_file_optional_t opt_type,
								   hid_t dxpl_id,
	...
	if ((args = (async_file_optional_args_t *)calloc (1, sizeof (async_file_optional_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((ret_value = H5VLfile_close (args->file, task->under_vol_id, args->dxpl_id, args->req)) <
		0) {
...
static herr_t async_file_close (
	int is_blocking, async_instance_t *aid, H5VL_async_t *parent_obj, hid_t dxpl_id, void **req) {
	async_task_t *async_task = NULL;
	/* H5O_token_t *token = NULL; */
...
static void async_group_create_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLgroup_create (args->obj, args->loc_params, task->under_vol_id, args->name,
								 args->lcpl_id, args->gcpl_id, args->gapl_id, args->dxpl_id,
								 args->req)) == NULL) {
...
static H5VL_async_t *async_group_create (int is_blocking,
										 async_instance_t *aid,
										 H5VL_async_t *parent_obj,
										 const H5VL_loc_params_t *loc_params,
										 const char *name,
	...
	if ((args = (async_group_create_args_t *)calloc (1, sizeof (async_group_create_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	args->name = strdup (name);
	if (lcpl_id > 0) args->lcpl_id = H5Pcopy (lcpl_id);
	if (gcpl_id > 0) args->gcpl_id = H5Pcopy (gcpl_id);
	if (gapl_id > 0) args->gapl_id = H5Pcopy (gapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
...
static void async_group_open_fn (void *foo) {
	void *obj;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLgroup_open (args->obj, args->loc_params, task->under_vol_id, args->name,
							   args->gapl_id, args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_group_open (int is_blocking,
									   async_instance_t *aid,
									   H5VL_async_t *parent_obj,
									   const H5VL_loc_params_t *loc_params,
									   const char *name,
...
static void async_group_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLgroup_get (args->obj, task->under_vol_id, args->get_type, args->dxpl_id, args->req,
					   args->arguments) < 0) {
...
static herr_t async_group_get (int is_blocking,
							   async_instance_t *aid,
							   H5VL_async_t *parent_obj,
							   H5VL_group_get_t get_type,
							   hid_t dxpl_id,
...
static void async_group_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLgroup_specific (args->obj, task->under_vol_id, args->specific_type, args->dxpl_id,
							args->req, args->arguments) < 0) {
...
static herr_t async_group_specific (int is_blocking,
									async_instance_t *aid,
									H5VL_async_t *parent_obj,
									H5VL_group_specific_t specific_type,
									hid_t dxpl_id,
	...
	if ((args = (async_group_specific_args_t *)calloc (1, sizeof (async_group_specific_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_group_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLgroup_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id, args->req,
							args->arguments) < 0) {
...
static herr_t async_group_optional (int is_blocking,
									async_instance_t *aid,
									H5VL_async_t *parent_obj,
									H5VL_group_optional_t opt_type,
									hid_t dxpl_id,
	...
	if ((args = (async_group_optional_args_t *)calloc (1, sizeof (async_group_optional_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_group_close_fn (void *foo) {
	herr_t ret_value;
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((ret_value = H5VLgroup_close (args->grp, task->under_vol_id, args->dxpl_id, args->req)) <
		0) {
...
static herr_t async_group_close (
	int is_blocking, async_instance_t *aid, H5VL_async_t *parent_obj, hid_t dxpl_id, void **req) {
	async_task_t *async_task = NULL;
	/* H5O_token_t *token = NULL; */
	...
	if ((args = (async_group_close_args_t *)calloc (1, sizeof (async_group_close_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_link_create_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_create (args->create_type, args->obj, args->loc_params, task->under_vol_id,
						 args->lcpl_id, args->lapl_id, args->dxpl_id, args->req,
						 args->arguments) < 0) {
...
herr_t async_link_create (int is_blocking,
						  async_instance_t *aid,
						  H5VL_link_create_type_t create_type,
						  H5VL_async_t *parent_obj,
						  const H5VL_loc_params_t *loc_params,
	...
	if ((args = (async_link_create_args_t *)calloc (1, sizeof (async_link_create_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	dup_loc_param (args->loc_params, loc_params);
	if (lcpl_id > 0) args->lcpl_id = H5Pcopy (lcpl_id);
	if (lapl_id > 0) args->lapl_id = H5Pcopy (lapl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
	va_copy (args->arguments, arguments);
...
static void async_link_copy_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_copy (args->src_obj, args->loc_params1, args->dst_obj, args->loc_params2,
					   task->under_vol_id, args->lcpl_id, args->lapl_id, args->dxpl_id,
					   args->req) < 0) {
...
static herr_t async_link_copy (int is_blocking,
							   async_instance_t *aid,
							   H5VL_async_t *parent_obj,
							   const H5VL_loc_params_t *loc_params1,
							   H5VL_async_t *parent_obj2,
							   const H5VL_loc_params_t *loc_params2,
							   hid_t lcpl_id,
							   hid_t lapl_id,
							   hid_t dxpl_id,
...
static void async_link_move_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_move (args->src_obj, args->loc_params1, args->dst_obj, args->loc_params2,
					   task->under_vol_id, args->lcpl_id, args->lapl_id, args->dxpl_id,
					   args->req) < 0) {
...
static herr_t async_link_move (int is_blocking,
							   async_instance_t *aid,
							   H5VL_async_t *parent_obj,
							   const H5VL_loc_params_t *loc_params1,
							   H5VL_async_t *parent_obj2,
...
static void async_link_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_get (args->obj, args->loc_params, task->under_vol_id, args->get_type,
					  args->dxpl_id, args->req, args->arguments) < 0) {
...
static herr_t async_link_get (int is_blocking,
							  async_instance_t *aid,
							  H5VL_async_t *parent_obj,
							  const H5VL_loc_params_t *loc_params,
							  H5VL_link_get_t get_type,
...
static void async_link_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_specific (args->obj, args->loc_params, task->under_vol_id, args->specific_type,
						   args->dxpl_id, args->req, args->arguments) < 0) {
...
static herr_t async_link_specific (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   const H5VL_loc_params_t *loc_params,
								   H5VL_link_specific_t specific_type,
	...
	if ((args = (async_link_specific_args_t *)calloc (1, sizeof (async_link_specific_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_link_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLlink_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id, args->req,
						   args->arguments) < 0) {
...
static herr_t async_link_optional (int is_blocking,
								   async_instance_t *aid,
								   H5VL_async_t *parent_obj,
								   H5VL_link_optional_t opt_type,
								   hid_t dxpl_id,
	...
	if ((args = (async_link_optional_args_t *)calloc (1, sizeof (async_link_optional_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_object_open_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if ((obj = H5VLobject_open (args->obj, args->loc_params, task->under_vol_id, args->opened_type,
								args->dxpl_id, args->req)) == NULL) {
...
static H5VL_async_t *async_object_open (int is_blocking,
										async_instance_t *aid,
										H5VL_async_t *parent_obj,
										const H5VL_loc_params_t *loc_params,
										H5I_type_t *opened_type,
	...
	if ((args = (async_object_open_args_t *)calloc (1, sizeof (async_object_open_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
...
static void async_object_copy_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLobject_copy (args->src_obj, args->src_loc_params, args->src_name, args->dst_obj,
						 args->dst_loc_params, args->dst_name, args->ocpypl_id, task->under_vol_id,
						 args->lcpl_id, args->dxpl_id, args->req) < 0) {
...
static herr_t async_object_copy (int is_blocking,
								 async_instance_t *aid,
								 H5VL_async_t *parent_obj,
								 const H5VL_loc_params_t *src_loc_params,
								 const char *src_name,
	...
	if ((args = (async_object_copy_args_t *)calloc (1, sizeof (async_object_copy_args_t))) ==
		NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
	...
	if (ocpypl_id > 0) args->ocpypl_id = H5Pcopy (ocpypl_id);
	if (lcpl_id > 0) args->lcpl_id = H5Pcopy (lcpl_id);
	if (dxpl_id > 0) args->dxpl_id = H5Pcopy (dxpl_id);
	args->req = req;
...
static void async_object_get_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLobject_get (args->obj, args->loc_params, task->under_vol_id, args->get_type,
						args->dxpl_id, args->req, args->arguments) < 0) {
...
static herr_t async_object_get (int is_blocking,
								async_instance_t *aid,
								H5VL_async_t *parent_obj,
								const H5VL_loc_params_t *loc_params,
								H5VL_object_get_t get_type,
...
static void async_object_specific_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLobject_specific (args->obj, args->loc_params, task->under_vol_id, args->specific_type,
							 args->dxpl_id, args->req, args->arguments) < 0) {
...
static herr_t async_object_specific (int is_blocking,
									 async_instance_t *aid,
									 H5VL_async_t *parent_obj,
									 const H5VL_loc_params_t *loc_params,
									 H5VL_object_specific_t specific_type,
	...
	if ((args = (async_object_specific_args_t *)calloc (
			 1, sizeof (async_object_specific_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
...
static void async_object_optional_fn (void *foo) {
	hbool_t acquired = false;
	int is_lock = 0, sleep_time = 500;
	unsigned int attempt_count, new_attempt_count;
	hbool_t is_lib_state_restored = false;
...
/* double time1 = get_elapsed_time(&args->start_time, &timer1); */
	...
	if (H5VLobject_optional (args->obj, task->under_vol_id, args->opt_type, args->dxpl_id,
							 args->req, args->arguments) < 0) {
...
static herr_t async_object_optional (int is_blocking,
									 async_instance_t *aid,
									 H5VL_async_t *parent_obj,
									 H5VL_object_optional_t opt_type,
									 hid_t dxpl_id,
	...
	if ((args = (async_object_optional_args_t *)calloc (
			 1, sizeof (async_object_optional_args_t))) == NULL) {
		fprintf (stderr, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
		goto error;
	}
#ifdef ENABLE_TIMING
 ...
 *---------------------------------------------------------------------------
 */
static void *H5VL_async_info_copy (const void *_info) {
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_info_cmp (int *cmp_value, const void *_info1, const void *_info2) {
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_info_free (void *_info) {
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_info_to_str (const void *_info, char **str) {
	const H5VL_async_info_t *info  = (const H5VL_async_info_t *)_info;
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_str_to_info (const char *str, void **_info) {
 ...
 *---------------------------------------------------------------------------
 */
static void *H5VL_async_wrap_object (void *obj, H5I_type_t obj_type, void *_wrap_ctx) {
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_free_wrap_ctx (void *_wrap_ctx) {
	H5VL_async_wrap_ctx_t *wrap_ctx = (H5VL_async_wrap_ctx_t *)_wrap_ctx;
	hid_t err_id;
...
static void *H5VL_async_attr_create (void *obj,
	...
	attr = async_attr_create (0, async_instance_g, o, loc_params, name, type_id, space_id, acpl_id,
							  aapl_id, dxpl_id, req);
...
static herr_t H5VL_async_attr_read (
	...
	if ((ret_value = async_attr_read (0, async_instance_g, o, mem_type_id, buf, dxpl_id, req)) <
		0) {
...
static herr_t H5VL_async_attr_write (
	...
	if ((ret_value = async_attr_write (0, async_instance_g, o, mem_type_id, buf, dxpl_id, req)) <
		0) {
...
static herr_t H5VL_async_attr_get (
	...
	if ((ret_value = async_attr_get (1, async_instance_g, o, get_type, dxpl_id, req, arguments)) <
		0) {
...
static herr_t H5VL_async_attr_specific (void *obj,
	...
	if ((ret_value = async_attr_specific (1, async_instance_g, o, loc_params, specific_type,
...
static herr_t H5VL_async_attr_optional (
	...
	if ((ret_value =
			 async_attr_optional (1, async_instance_g, o, opt_type, dxpl_id, req, arguments)) < 0) {
...
static void *H5VL_async_dataset_create (void *obj,
	...
	dset = async_dataset_create (0, async_instance_g, o, loc_params, name, lcpl_id, type_id,
...
static herr_t H5VL_async_dataset_read (void *dset,
	...
	if ((ret_value = async_dataset_read (0, async_instance_g, o, mem_type_id, mem_space_id,
...
static herr_t H5VL_async_dataset_write (void *dset,
	...
	if ((ret_value = async_dataset_write (0, async_instance_g, o, mem_type_id, mem_space_id,
										  file_space_id, plist_id, buf, req)) < 0) {
...
static herr_t H5VL_async_dataset_get (
	...
	if ((ret_value =
			 async_dataset_get (1, async_instance_g, o, get_type, dxpl_id, req, arguments)) < 0) {
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_dataset_specific (void *obj,
										   H5VL_dataset_specific_t specific_type,
										   hid_t dxpl_id,
										   void **req,
										   va_list arguments) {
	...
	// For H5Dwait
	if (H5VL_DATASET_WAIT == specific_type) return (H5VL_async_dataset_wait (o));

	if ((ret_value = async_dataset_specific (1, async_instance_g, o, specific_type, dxpl_id, req,
											 arguments)) < 0) {
...
static herr_t H5VL_async_dataset_optional (
	...
	if ((ret_value = async_dataset_optional (1, async_instance_g, o, opt_type, dxpl_id, req,
											 arguments)) < 0) {
...
static void *H5VL_async_datatype_commit (void *obj,
	...
	dt = async_datatype_commit (0, async_instance_g, o, loc_params, name, type_id, lcpl_id, tcpl_id,
								tapl_id, dxpl_id, req);
...
static herr_t H5VL_async_datatype_get (
	...
	if ((ret_value =
			 async_datatype_get (1, async_instance_g, o, get_type, dxpl_id, req, arguments)) < 0) {
...
static herr_t H5VL_async_datatype_specific (void *obj,
	...
	if ((ret_value = async_datatype_specific (1, async_instance_g, o, specific_type, dxpl_id, req,
											  arguments)) < 0) {
...
static herr_t H5VL_async_datatype_optional (
	...
	if ((ret_value = async_datatype_optional (1, async_instance_g, o, opt_type, dxpl_id, req,
											  arguments)) < 0) {
...
static void *H5VL_async_file_create (
	...
	file =
		async_file_create (0, async_instance_g, name, flags, fcpl_id, under_fapl_id, dxpl_id, req);
...
static herr_t H5VL_async_file_get (
	...
	if ((ret_value = async_file_get (1, async_instance_g, o, get_type, dxpl_id, req, arguments)) <
		0) {
...
static herr_t H5VL_async_file_specific (
	...
	if (specific_type == H5VL_FILE_MOUNT) {
		...
		ret_value = H5VL_async_file_specific_reissue (o->under_object, under_vol_id, specific_type,
		...
		ret_value = H5VL_async_file_specific_reissue (NULL, under_vol_id, specific_type, dxpl_id,
		...
		if (specific_type == H5VL_FILE_REOPEN) va_copy (my_arguments, arguments);

		/* Keep the correct underlying VOL ID for possible async request token */
		under_vol_id = o->under_vol_id;

		if ((ret_value = async_file_specific (1, async_instance_g, o, specific_type, dxpl_id, req,
											  arguments)) < 0) {
		...
		if (specific_type == H5VL_FILE_REOPEN) {
			if (ret_value >= 0) {
				...
				if (ret && *ret) *ret = H5VL_async_new_obj (*ret, o->under_vol_id);
			} /* end if */
...
static herr_t H5VL_async_file_optional (
	...
	if ((ret_value =
			 async_file_optional (1, async_instance_g, o, opt_type, dxpl_id, req, arguments)) < 0) {
...
static void *H5VL_async_group_create (void *obj,
	...
	group = async_group_create (0, async_instance_g, o, loc_params, name, lcpl_id, gcpl_id, gapl_id,
								dxpl_id, req);
...
static herr_t H5VL_async_group_get (
	...
	if ((ret_value = async_group_get (1, async_instance_g, o, get_type, dxpl_id, req, arguments)) <
		0) {
...
static herr_t H5VL_async_group_specific (
	...
	if ((ret_value = async_group_specific (1, async_instance_g, o, specific_type, dxpl_id, req,
										   arguments)) < 0) {
...
static herr_t H5VL_async_group_optional (
	...
	if ((ret_value = async_group_optional (1, async_instance_g, o, opt_type, dxpl_id, req,
										   arguments)) < 0) {
...
static herr_t H5VL_async_link_create (H5VL_link_create_type_t create_type,
	...
	if (o->create_task == NULL || !o->is_obj_valid) return (-1);
	...
	if (H5VL_LINK_CREATE_HARD == create_type) {
		...
		ret_value = async_link_create (0, async_instance_g, create_type, o, loc_params, lcpl_id,
...
static herr_t H5VL_async_link_copy (void *src_obj,
	...
	if (o_src->create_task == NULL || !o_src->is_obj_valid) return (-1);
	if (o_dst->create_task == NULL || !o_dst->is_obj_valid) return (-1);
	...
	ret_value = async_link_copy (0, async_instance_g, o_src, loc_params1, o_dst, loc_params2,
...
static herr_t H5VL_async_link_move (void *src_obj,
	...
	ret_value = async_link_move (0, async_instance_g, o_src, loc_params1, o_dst, loc_params2,
								 lcpl_id, lapl_id, dxpl_id, req);
...
static herr_t H5VL_async_link_get (void *obj,
	...
	ret_value =
		async_link_get (1, async_instance_g, o, loc_params, get_type, dxpl_id, req, arguments);
...
static herr_t H5VL_async_link_specific (void *obj,
	...
	ret_value = async_link_specific (1, async_instance_g, o, loc_params, specific_type, dxpl_id,
									 req, arguments);
...
static herr_t H5VL_async_object_copy (void *src_obj,
	...
	if ((ret_value =
			 async_object_copy (0, async_instance_g, o_src, src_loc_params, src_name, o_dst,
...
static herr_t H5VL_async_object_get (void *obj,
	...
	if ((ret_value = async_object_get (1, async_instance_g, o, loc_params, get_type, dxpl_id, req,
									   arguments)) < 0) {
...
static herr_t H5VL_async_object_specific (void *obj,
	...
	if ((ret_value = async_object_specific (1, async_instance_g, o, loc_params, specific_type,
											dxpl_id, req, arguments)) < 0) {
...
static herr_t H5VL_async_object_optional (
	...
	if ((ret_value = async_object_optional (1, async_instance_g, o, opt_type, dxpl_id, req,
											arguments)) < 0) {
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_wait (void *obj, uint64_t timeout, H5ES_status_t *status) {
	herr_t ret_value = 0;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_cancel (void *obj) {
	H5VL_async_t *o = (H5VL_async_t *)obj;
	herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_specific (void *obj,
										   H5VL_request_specific_t specific_type,
										   va_list arguments) {
	herr_t ret_value = -1;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_optional (void *obj,
										   H5VL_request_optional_t opt_type,
										   va_list arguments) {
	H5VL_async_t *o = (H5VL_async_t *)obj;
	herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_free (void *obj) {
	/* H5VL_async_t *o = (H5VL_async_t *)obj; */
	/* herr_t ret_value; */
